...
export default function CardProject({
  ...
  return (
    <article
      ...
      className="group relative flex w-full max-w-135 flex-col items-start justify-start gap-5"
    >
      <div className="card-project-image relative overflow-hidden">
        <Image
          ...
          loading="eager"
        />
        <div className="card-project-buttons absolute inset-0 bg-black/75 opacity-0 not-lg:hidden group-hover:opacity-100 group-hover:transition-all group-hover:delay-75 group-hover:ease-linear">
      ...
      <div className="card-project-head space-y-1.75">
        <h3 className="text-base-white text-heading-m">{title}</h3>
