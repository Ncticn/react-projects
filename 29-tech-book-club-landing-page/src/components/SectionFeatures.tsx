...
function FeaturesStep({ title, counter }: FeaturesStepProps) {
  return (
    <div className="features-step relative space-y-6 lg:max-w-[226.5px] not-last:lg:before:absolute not-last:lg:before:top-0 not-last:lg:before:right-0 not-last:lg:before:h-5 not-last:lg:before:w-20 not-last:lg:before:bg-[url(src/assets/patterns/pattern-arrow.svg)] not-last:lg:before:bg-center not-last:lg:before:bg-no-repeat">
  ...
  return (
    <section aria-label="Section Features">
      <div className="mx-auto max-w-85 md:max-w-176 lg:max-w-292.5">
        <div className="relative overflow-hidden rounded-xl bg-neutral-100 bg-[url(src/assets/patterns/pattern-light-bg.svg)] bg-cover bg-no-repeat px-4 py-16 md:px-8 md:py-20 lg:px-0">
