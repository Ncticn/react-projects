...
export default function IconBase({ iconType }: IconBaseProps) {
  let currentIcon;

  switch (iconType) {
    case "icon-battery":
      currentIcon = <IconBattery />;
      break;
    case "icon-bluetooth":
      currentIcon = <IconBluetooth />;
      break;
    case "icon-compatible":
      currentIcon = <IconCompatible />;
      break;
    case "icon-light":
  ...
  return (
    <div className="icon-base" aria-label="Icon base">
      <div className="size-16.25 rounded-2xl bg-orange-500 text-white">
