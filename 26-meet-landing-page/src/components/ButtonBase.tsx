...
export default function ButtonBase({
  ...
  return (
    <a
      ...
      className={`text-preset-5 text-white-base inline-flex flex-row items-start justify-start gap-2 rounded-[29px] px-10 py-4 transition-colors delay-100 ease-linear ${customClass}`}
    >
      {text && <span>{text}</span>}
      {extraText && (
        <span
