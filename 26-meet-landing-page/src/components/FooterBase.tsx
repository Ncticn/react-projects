...
export default function FooterBase() {
  return (
    <>
      <footer>
        <div className="relative bg-[url(../images/image-footer-mobile.jpg)] bg-cover bg-top bg-no-repeat px-8 py-16 before:absolute before:inset-0 before:bg-cyan-600 before:opacity-80 md:bg-[url(../images/image-footer-tablet.jpg)] md:bg-center lg:bg-[url(../images/image-footer.jpg)] lg:px-20 lg:py-28">
