...
export default function CardLimitation({ icon, title, description }: CardLimitationProps) {
    return (
        <div className="card-limitation *:h-full *:w-full h-full w-full max-w-91.25">
            <div className="bg-white rounded-2xl px-6 py-6 drop-shadow-[16px_32px_56px_rgba(143,174,207,0.25)]">
