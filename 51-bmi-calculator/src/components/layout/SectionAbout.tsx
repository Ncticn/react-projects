            ...
            <div className="mx-auto max-w-full md:max-w-290 not-lg:md:-translate-x-20">
                <div className="flex flex-col md:flex-row items-end justify-between gap-12 md:gap-18 lg:relative lg:overflow-hidden">
                    <motion.div
                        ...
                        transition={{ type:"spring", delay: .75, stiffness: 25 }}
                        className="min-w-full md:min-w-108.75 lg:min-w-141 shrink">
                    ...
                    <motion.div
                        ...
                        transition={{ delay: .75, type: "spring" }}

                        className="space-y-8 px-6 md:px-0 md:w-82.75 lg:w-116.25 flex-none pb-8">
