...
export default function SectionLimitations() {
  ...
  return (
    <section
      aria-label="Section Limitations of BMI"
      className="lg:px-36 lg:py-26"
    >
      <div className="relative mx-auto max-w-81.75 md:max-w-171.5 lg:max-w-290">
        <div className="flex flex-col items-start justify-start gap-8 lg:flex-row">
          <div className="space-y-8 text-center lg:max-w-141 lg:text-start">
          ...
          <div className="not-lg:hidden lg:absolute lg:right-0">
            <div className="flex w-5xl flex-col flex-wrap items-center justify-center gap-8">
              <div className="flex w-full items-center justify-center pl-96">
                <CardLimitation
                  key={limitations[0].id}
          ...
          <div className="not-lg:grid not-lg:grid-cols-1 not-lg:items-stretch not-lg:justify-center not-lg:gap-8 not-lg:md:grid-cols-2 lg:hidden">
            {limitations.map((limitation) => (
              <div
                key={limitation.id}
                className="col-span-1 md:not-last:col-span-1 md:last:col-span-2 md:last:*:mx-auto"
              >
